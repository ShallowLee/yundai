...
class WxPayApi
{
	...
	{		
		...
		if(stripos($url,"https://")!==FALSE){
			...
			curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, FALSE);  //后来修改的部分
			curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, FALSE);  //后来修改的部分
        } else {
			curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,TRUE);
			curl_setopt($ch,CURLOPT_SSL_VERIFYHOST,2);        //严格校验 微信支付原版这么写
		} 
