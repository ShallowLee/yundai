...
function xiane(id){
	var sheight = "350px";
	var swidth = "500px";
	var k = window.showModalDialog("/SjtAdminSjt_ShangHu_xiane_UserID_"+id+".html?aaa="+ Math.random(),window,'dialogWidth:'+swidth+'px;dialogHeight:'+sheight+'px;edge:raised;resizable:no;scroll:no;status:no;center:yes;help:no;minimize:no;maximize:no;fullscreen:no;');
