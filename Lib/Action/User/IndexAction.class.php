...
class IndexAction extends Action{
    ...
    */
    ...
    public function wyjyjl(){
		//显示所有记录
          $wherestr = "UserID = ".session("UserID")." and (typepay = 0 or typepay = 1)";
          $Order = M("Order");
          import("ORG.Util.Page");       //导入分页类 
...
public function mypay(){
   ...
   public function xgjkedit(){//修改接口編輯
